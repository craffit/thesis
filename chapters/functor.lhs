The typing functor is the heart of the type and transform system. The use of this functor gives rise to both the type-correctness as well as the semantic correctness of |(TTS(stlc))| through the logical relation. The fact that this works out is because the typing functor is an actual functor as known in the field category theory. It is purely out of theoretical curiosity that we show this property here. Before showing that the typing functor is a proper functor, we introduce the concept of functors and difunctors.
...
>`beq` { Eta expansion }
>  ((dimap_(tyF_(a) -> (tyF_(r)))) g1 g2 `comp` (dimap_(tyF_(a) -> (tyF_(r)))) f1 f2) x
>`beq` { Definition composition }
>  (dimap_(tyF_(a) -> (tyF_(r)))) g1 g2 ((dimap_(tyF_(a) -> (tyF_(r)))) f1 f2 x)
